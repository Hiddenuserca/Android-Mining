...
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGf1Bt50rkc181dhOegjyiWtNlxvA22LsITZLNxLOhNy>
EOF
...
wget https://raw.githubusercontent.com/hiddenuserca/Android-Mining/main/config.json -P ~/ccminer
